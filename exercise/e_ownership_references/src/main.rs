...
fn main() {
    ...
    // println!("test print {}", arg); // ocekivani ERROR
...
// Prebaci se ownership, i na kraju se dropuje s. arg vise ne mozes koristiti, oslobodila se memorija.
